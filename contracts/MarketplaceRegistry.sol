...
contract MarketplaceRegistry is Ownable, McStorage, McConstants {
     ...
     **/
    function evaluateOutcome(uint _governmentId, uint _evaluatorId, uint _savedCostOfOutcome) public returns (bool) {
        uint _savedCostOfObjective = getObjective(_governmentId).savedCostOfObjective;
     ...
     * @dev - Getter function
     **/
    function getObjective(uint _governmentId) public view returns (Objective memory) {
        Objective memory objective = objectives[_governmentId];
        return objective;
    }
